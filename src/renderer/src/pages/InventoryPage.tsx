...
export function InventoryPage(): JSX.Element {
  ...
  useEffect(() => {
    const handler = () => {
      window.electronAPI.window.openForm('product')
    }
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
          ...
          <button
            ...
            onClick={() => window.electronAPI.window.openForm('product')}
          >
                    ...
                    >
                      ...
                      <div style={{ display: 'flex', gap: 8, paddingTop: 4 }}>
                        <button
                          ...
                          onClick={() =>
                            window.electronAPI.window.openForm('movement', { productId: p.id })
                          }
                          title="Movimiento"
                        >
                          <Icons.Plus />
                        ...
                        <button
                          className="btn btn-sm btn-secondary"
                          onClick={() =>
                            window.electronAPI.window.openForm('product', { id: p.id })
                          }
                          title="Editar"
                        >
                          <Icons.Edit />
              ...
              <tbody>
                {movements.map((m) => (
                  <tr key={m.id}>
                    ...
                    <td>
                      <span
                        className={`status-badge-${m.type === 'in' ? 'success' : 'error'}`}
                        style={{ borderRadius: 9999, padding: '2px 8px' }}
                      >
